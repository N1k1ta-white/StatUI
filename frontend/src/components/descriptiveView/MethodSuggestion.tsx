...
export default function MethodSelection() {
    ...
    return (
        <div className="w-full max-w-lg space-y-6 p-4 bg-white rounded-xl shadow">
            <h2 className="text-xl font-semibold">Выберите категорию и метод</h2>
                ...
                <div key={category} className="border-b pb-4 mb-4">
                    ...
                    {selectedMethods[category] && (
                        <div className="ml-6 mt-4">
                            <h3 className="text-sm font-medium">Выберите столбцы:</h3>
